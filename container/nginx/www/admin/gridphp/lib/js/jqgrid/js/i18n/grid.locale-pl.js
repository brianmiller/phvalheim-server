;(function($){
	 ...
	 *
	 * Small update
	 * Zbyszek Rybarczyk zbigniew.rybarczyk@gmail.com
	 *
	...
	**/
	...
	$.extend($.jgrid,{
		...
		edit : {
			...
			cloneData: "Powielić wybrany rekord?",
			bYes: "Tak",
			bNo: "Nie",
			bExit: "Anuluj",
			msg: {
		...
		nav : {
			...
			columns : "Kolumny",
			showhidecol : "Wybierz kolumny do wyświetlenia",
			bulkedit: "Bulk Edit",
			bulkeditskip : "Info: puste pola będą pominięte",
			clone : "Powiel",
			'export' : "Eksportuj",
			'saveRow' : "Zapisz ten wiersz",
			'restoreRow' : "Przywróć ten wiersz"
		},
		col : {
