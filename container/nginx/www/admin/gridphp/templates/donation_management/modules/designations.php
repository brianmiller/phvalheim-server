...
// grid properties
$grid->table = "tb_designations";
$grid->select_command = "SELECT tb_designations.id, tb_designations.name, tb_designations.program_description, (SELECT group_concat(id ORDER BY id DESC) FROM tb_donations WHERE tb_designations.id = tb_donations.designated_program AND 1=1) AS designated_donations, (SELECT sum(amount) FROM tb_donations WHERE tb_designations.id = tb_donations.designated_program AND 1=1) AS donation_total FROM tb_designations  WHERE 1=1 ";
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_designations.updated_at";
$col["frozen"] = true;
$cols[] = $col;
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_designations.created_at";
$col["frozen"] = true;
$cols[] = $col;
...
$col["dbname"] = "tb_designations.name";
$col["frozen"] = true;
$col["position"] = 1;
$cols[] = $col;

$col = array();
$col["name"] = "program_description";
$col["width"] = 150;
$col["editable"] = true;
$col["dbname"] = "tb_designations.program_description";
$col["position"] = 2;
$cols[] = $col;

$col = array();
$col["name"] = "designated_donations";
$col["width"] = 400;
$col["editable"] = false;
$col["dbname"] = "(SELECT group_concat(id ORDER BY id DESC) FROM tb_donations WHERE tb_designations.id = tb_donations.designated_program AND 1=1)";
$col["formatter"] = "badge";
$col["edittype"] = "select";
...
$col = array();
$col["name"] = "donation_total";
$col["width"] = 100;
$col["editable"] = false;
$col["dbname"] = "(SELECT sum(amount) FROM tb_donations WHERE tb_designations.id = tb_donations.designated_program AND 1=1)";
...
$grid_id = "list_designations";

// template variables
$var = array();
$var["out_grid"] = $grid->render($grid_id);
$var["grid_id"] = "list_designations";
$var["grid_theme"] = "base";
$var["locale"] = "en";
$var["form_title"] = "Designations Management";
$var["form_details"] = "";
$var["tab_class"] = "";
