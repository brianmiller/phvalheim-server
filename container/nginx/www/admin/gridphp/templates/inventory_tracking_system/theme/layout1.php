...
$links = array();
$links["product_inventory"] = array("Product Inventory","index.php?mod=product_inventory",false);
$links["warehouse_locations"] = array("Warehouse Locations","index.php?mod=warehouse_locations",false);
$links["manufacturers"] = array("Manufacturers","index.php?mod=manufacturers",false);
$links["purchase_orders"] = array("Purchase Orders","index.php?mod=purchase_orders",false);
$links["sales_orders"] = array("Sales Orders","index.php?mod=sales_orders",false);
...
<head>
	...
	<style>:root{--bs-dark-rgb: 4, 138, 14;--tabcolor: #047c0d;--tabhover: #046f0c;}</style>
</head>
