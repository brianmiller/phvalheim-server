...
// grid properties
$grid->table = "tb_settings";
$grid->select_command = "SELECT tb_settings.id, tb_settings.title, tb_settings.name, tb_settings.value FROM tb_settings  WHERE 1=1 ";
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_settings.updated_at";
$cols[] = $col;
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_settings.created_at";
$cols[] = $col;
...
$col["width"] = 200;
$col["editable"] = true;
$col["dbname"] = "tb_settings.value";
$col["position"] = 3;
$cols[] = $col;

$grid->set_columns($cols,true);

$grid_id = "list_settings";

// template variables
$var = array();
$var["out_grid"] = $grid->render($grid_id);
$var["grid_id"] = "list_settings";
$var["grid_theme"] = "base";
$var["locale"] = "en";
$var["form_title"] = "Settings Management";
$var["form_details"] = "";
$var["tab_class"] = "";
