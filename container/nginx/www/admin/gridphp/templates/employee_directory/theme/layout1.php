...
$links = array();
$links["employees"] = array("Employees","index.php?mod=employees",false);
$links["department_wise"] = array("Department Wise","index.php?mod=department_wise",false);
$links["on_leave"] = array("On Leave","index.php?mod=on_leave",false);
$links["contact_numbers"] = array("Contact Numbers","index.php?mod=contact_numbers",false);
$links["departments"] = array("Departments","index.php?mod=departments",false);
...
<head>
	...
	<style>:root{--bs-dark-rgb: 124, 55, 239;--tabcolor: #6f31d7;--tabhover: #642cc1;}</style>
</head>
