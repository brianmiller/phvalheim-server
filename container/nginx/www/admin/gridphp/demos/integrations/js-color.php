...
$col["width"] = "30";
$col["editable"] = true;
$col["editoptions"]["dataInit"] = "function(o){ jQuery(o).colorPicker(); }";
$cols[] = $col;	
...
<head>
	...
	<script src="//cdnjs.cloudflare.com/ajax/libs/tinyColorPicker/1.1.1/jqColorPicker.min.js" type="text/javascript"></script>
</head>
<body>
