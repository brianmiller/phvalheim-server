...
// {name} is hardcoded as input term
$col["editoptions"]["onchange"]["sql"] = "select distinct client_id as 'id', name as 'text' from clients where `name` like '%{name}%'";
$col["editoptions"]["dataInit"] = "function(){ setTimeout(function(){ link_select2_ajax('{$col["name"]}'); },200); }";

$col["stype"] = "select"; // render as select
$col["searchoptions"] = array("value"=>$str); 
$col["searchoptions"]["dataInit"] = "function(){ setTimeout(function(){ link_select2_ajax('gs_{$col["name"]}'); },200); }";
$cols[] = $col;
															...
															{	
																ajax: {
																	...
																	data: function (params) {
																		...
																		// to enable ajax search on filter row
																		id = id.replace("gs_","");
																		var query = {
																			src: id,
																			event: 'onchange',
