...
<head>
	...
	<title>Using Grid 4 PHP Framework with Bootstrap v5.1</title>
...
<body class="d-flex flex-column h-100">
	<header>
		...
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">Grid 4 PHP Framework + Bootstrap v5</a>
	...
	<main class="flex-shrink-0">
		...
		<div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 220px; margin-top:50px">
			...
			<div class="dropdown">
				<a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle"
					...
					<img src="https://getbootstrap.com/docs/5.0/assets/brand/bootstrap-logo.svg" alt="" width="32" height="32" class="rounded-circle me-2">
					<strong>More</strong>
				</a>
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				...
				<li class="nav-item" role="presentation">
					<button class="nav-link" id="invoice-tab" data-bs-toggle="tab" data-bs-target="#invoice"
						type="button" role="tab" aria-controls="invoice" aria-selected="false">Invoices</button>
				</li>
			</ul>
