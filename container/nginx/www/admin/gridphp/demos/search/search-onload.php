...
$sarr = <<< SEARCH_JSON
{
    "groupOp":"AND",
    "rules":[
      {"field":"name","op":"cn","data":"Maria Anders"},
...
$str = $g->get_dropdown_values("select distinct name as k, name as v from clients limit 10");
...
$col["searchoptions"] = array("searchhidden" => true, "sopt" => array("eq"));
$cols[] = $col;
