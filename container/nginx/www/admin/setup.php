...
<body>
        ...
        <div class="setup-card">
            ...
            <div class="setup-step" data-step="3">
                ...
                <div class="setup-field">
                    ...
                    <input type="text" id="setup-defaultSeed" value="" maxlength="10" placeholder="Random seed">
                    <div class="field-help">Used when no seed is specified during world creation. Leave blank for random.</div>
                </div>
    ...
    function getSettings() {
        return {
            ...
            defaultSeed: document.getElementById('setup-defaultSeed').value.trim(),
    ...
    function buildReviewTable() {
        ...
        const rows = [
            ...
            ['Default Seed', s.defaultSeed || '(random)'],
